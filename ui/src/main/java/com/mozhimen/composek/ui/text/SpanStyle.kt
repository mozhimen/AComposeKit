...
import com.mozhimen.composek.ui.text.style.TextForegroundStyle
import com.mozhimen.composek.ui.text.style.TextGeometricTransform
import com.mozhimen.composek.ui.text.style.lerp
import com.mozhimen.composek.ui.text.font.lerp
...
internal fun lerpTextUnitInheritable(a: TextUnit, b: TextUnit, t: Float): TextUnit {
    ...
    return androidx.compose.ui.unit.lerp(a, b, t)
}
...
fun lerp(start: SpanStyle, stop: SpanStyle, fraction: Float): SpanStyle {
    return SpanStyle(
        ...
        shadow = androidx.compose.ui.graphics.lerp(
            start.shadow ?: Shadow(),
            stop.shadow ?: Shadow(),
            fraction
        ),
