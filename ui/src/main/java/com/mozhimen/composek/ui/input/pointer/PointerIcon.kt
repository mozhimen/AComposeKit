...
import com.mozhimen.composek.ui.node.PointerInputModifierNode
import com.mozhimen.composek.ui.node.TraversableNode
import com.mozhimen.composek.ui.node.currentValueOf
import com.mozhimen.composek.ui.node.traverseAncestors
import com.mozhimen.composek.ui.node.traverseDescendants
import com.mozhimen.composek.ui.platform.LocalPointerIconService
...
internal class PointerHoverIconModifierNode(
    ...
    private fun findDescendantNodeWithCursorInBounds(): PointerHoverIconModifierNode? {
        ...
        traverseDescendants {
            var actionForSubtreeOfCurrentNode = TraversableNode.Companion.TraverseDescendantsAction.ContinueTraversal
