...
import com.mozhimen.composek.ui.text.input.TextInputServiceAndroid.TextInputCommand.HideKeyboard
import com.mozhimen.composek.ui.text.input.TextInputServiceAndroid.TextInputCommand.ShowKeyboard
import com.mozhimen.composek.ui.text.input.TextInputServiceAndroid.TextInputCommand.StartInput
import com.mozhimen.composek.ui.text.input.TextInputServiceAndroid.TextInputCommand.StopInput
/**
 * @ClassName TextInputServiceAndroid
 * @Description TODO
 * @Author mozhimen
 * @Date 2024/10/30
 * @Version 1.0
...
internal class TextInputServiceAndroid(
    ...
    override fun notifyFocusedRect(rect: androidx.compose.ui.geometry.Rect) {
        focusedRect = Rect(
        ...
        if (ics.isEmpty()) {
            focusedRect?.let {
                ...
                view.requestRectangleOnScreen(Rect(it))
            }
        }
    }
    ...
    override fun updateTextLayoutResult(
        ...
        innerTextFieldBounds: androidx.compose.ui.geometry.Rect,
        decorationBoxBounds: androidx.compose.ui.geometry.Rect
    ) {
