...
import com.mozhimen.composek.ui.node.traverseChildren
import com.mozhimen.composek.ui.node.traverseDescendants

/**
 * @ClassName DragAndDropNode
 * @Description TODO
 * @Author Mozhimen / Kolin Zhao
 * @Date 2024/10/30 1:36
 * @Version 1.0
 */
/**
        ...
        private inline fun DragAndDropModifierNode.firstChildOrNull(
            ...
            traverseDescendants(DragAndDropTraversableKey) { child ->
                if (child is DragAndDropModifierNode && predicate(child)) {
                    match = child
                    return@traverseDescendants TraversableNode.Companion.TraverseDescendantsAction.CancelTraversal
                }
