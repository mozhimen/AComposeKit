...
import com.mozhimen.composek.ui.text.AnnotatedString.Range
import com.mozhimen.composek.ui.text.AnnotatedString.Builder
/**
 ...
 */
private fun <T> filterRanges(ranges: List<AnnotatedString.Range<out T>>?, start: Int, end: Int): List<AnnotatedString.Range<T>>? {
