...
/**
 * @ClassName MeasureAndLayoutDelegate
 * @Description TODO
 * @Author Mozhimen / Kolin Zhao
 * @Date 2024/10/30 2:09
 * @Version 1.0
 */
/**
...
internal class MeasureAndLayoutDelegate(private val root: LayoutNode) {
    ...
    fun requestLookaheadRemeasure(layoutNode: LayoutNode, forced: Boolean = false): Boolean {
        ...
        return when (layoutNode.layoutState) {
            ...
            LayoutNode.LayoutState.Measuring, LayoutNode.LayoutState.LookaheadLayingOut, LayoutNode.LayoutState.LayingOut -> {
    ...
    private fun doLookaheadRemeasure(layoutNode: LayoutNode, constraints: Constraints?): Boolean {
        ...
        if (lookaheadSizeChanged && parent != null) {
            ...
            } else if (layoutNode.measuredByParentInLookahead == LayoutNode.UsageByParent.InMeasureBlock) {
                requestLookaheadRemeasure(parent)
            } else if (layoutNode.measuredByParentInLookahead == LayoutNode.UsageByParent.InLayoutBlock) {
    ...
    private val LayoutNode.measureAffectsParent
        get() = (measuredByParent == LayoutNode.UsageByParent.InMeasureBlock ||
    ...
    private val LayoutNode.measureAffectsParentLookahead
        get() = (measuredByParentInLookahead == LayoutNode.UsageByParent.InMeasureBlock ||
