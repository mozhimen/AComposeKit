...
/**
 * @ClassName SnapshotStateList
 * @Description TODO
 * @Author Mozhimen / Kolin Zhao
 * @Date 2024/10/20 23:22
 * @Version 1.0
 */
 ...
 */
@Stable
class SnapshotStateList<T> : StateObject, MutableList<T>, RandomAccess, IUtilK {
    ...
    private inline fun conditionalUpdate(
        ...
        run {
            ...
            while (true) {
                ...
                if (newList == oldList) {
                    Log.d("SnapshotStateList>>>>>", "conditionalUpdate: newList == oldList newList ${newList.javaClass} oldList ${oldList?.javaClass}")
                    Log.d("SnapshotStateList>>>>>", "conditionalUpdate: newList == oldList newList ${newList}")
                    Log.d("SnapshotStateList>>>>>", "conditionalUpdate: newList == oldList oldList ${oldList}")
                    result = false
                    break
                }
                if (writable {
